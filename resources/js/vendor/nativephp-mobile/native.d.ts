...
export interface BottomNavItemOptions {
    id: string;
    icon: string;
    url: string;
    label: string;
...
export interface TopBarActionOptions {
    id: string;
    icon: string;
    label?: string | null;
    url?: string | null;
...
export interface SideNavHeaderOptions {
    title?: string;
    subtitle?: string;
    icon?: string;
    backgroundColor?: string;
...
export interface SideNavGroupOptions {
    heading: string;
    expanded?: boolean;
    icon?: string;
}
...
export class EdgeBuilder {
     ...
     */
    bottomNav(options?: BottomNavOptions): EdgeBuilder;

    /**
     * Bottom Navigation Item
     */
    bottomNavItem(options: BottomNavItemOptions): EdgeBuilder;

    /**
     * Top Bar (AppBar/Toolbar)
     */
    topBar(options: TopBarOptions): EdgeBuilder;

    /**
     * Top Bar Action Button
     */
    topBarAction(options: TopBarActionOptions): EdgeBuilder;

    /**
     * Floating Action Button (FAB)
     */
    fab(options: FabOptions): EdgeBuilder;

    /**
     * Side Navigation Drawer
     */
    sideNav(options?: SideNavOptions): EdgeBuilder;

    /**
     * Side Navigation Header
     */
    sideNavHeader(options?: SideNavHeaderOptions): EdgeBuilder;

    /**
     * Side Navigation Item
     */
    sideNavItem(options: SideNavItemOptions): EdgeBuilder;

    /**
     * Side Navigation Group (collapsible section)
     */
    sideNavGroup(options: SideNavGroupOptions): EdgeBuilder;

    /**
     * Horizontal Divider
     */
    horizontalDivider(): EdgeBuilder;
 ...
 */
export function edgeBuilder(): EdgeBuilder;

export const edge: {
    set: typeof setEdge;
    builder: typeof edgeBuilder;
};
